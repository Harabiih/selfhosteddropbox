  ...
  return (
    <>
      <Box
        ...
        p={7}
        textAlign="center"
        color={isDragActive ? "pink.400" : "gray.400"}
      ...
      >
        ...
        <Button leftIcon={<FaFileUpload />} colorScheme="purple" mt={4}>
          Browse Files
        </Button>
      </Box>
        ...
        <AlertDialogOverlay>
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              ...
              <Button colorScheme="pink" onClick={handleFileRename} ml={3}>
                Rename
              </Button>
            </AlertDialogFooter>
          </AlertDialogContent>
            ...
            >
              <VStack spacing={3}>
                {uploadingFiles.map((file) => (
                  <Box key={file.id} bg="gray.500" color="white" p={4} borderRadius="md">
